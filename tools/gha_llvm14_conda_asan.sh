...
conda create -y -q -p $deps_dir c-compiler cxx-compiler cmake 'llvmdev=14' tbb-devel tbb boost-cpp 'mppp>=0.23' sleef xtensor xtensor-blas blas blas-devel fmt spdlog
