...
conda create -y -q -p $deps_dir c-compiler cxx-compiler cmake llvmdev tbb-devel tbb libboost-devel 'mppp=1.*' sleef xtensor xtensor-blas blas blas-devel fmt spdlog
