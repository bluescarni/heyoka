...
conda create -y -q -p $deps_dir c-compiler cxx-compiler cmake llvmdev=13.0.0 tbb-devel tbb boost-cpp 'mppp>=0.27' sleef xtensor xtensor-blas blas blas-devel fmt spdlog
