...
mamba create -y -q -p $deps_dir c-compiler cxx-compiler cmake 'llvmdev=13.*' tbb-devel tbb boost-cpp 'mppp=1.*' sleef xtensor xtensor-blas blas blas-devel fmt spdlog
