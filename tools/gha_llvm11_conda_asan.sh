...
conda create -y -q -p $deps_dir c-compiler cxx-compiler cmake llvmdev=11.1.0 tbb-devel tbb boost-cpp mppp sleef xtensor xtensor-blas blas blas-devel fmt spdlog
