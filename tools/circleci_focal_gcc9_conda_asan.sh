...
conda create -y -q -p $deps_dir cmake llvmdev boost-cpp mppp sleef xtensor xtensor-blas blas blas-devel fmt spdlog sphinx sphinxcontrib-bibtex sphinx-book-theme
