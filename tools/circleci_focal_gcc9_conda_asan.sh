...
conda create -y -q -p $deps_dir c-compiler cxx-compiler cmake llvmdev boost-cpp mppp sleef xtensor xtensor-blas blas blas-devel fmt spdlog sphinx sphinxcontrib-bibtex sphinx-book-theme
