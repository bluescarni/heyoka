...
mamba create -y -q -p $deps_dir c-compiler cxx-compiler cmake 'llvmdev=16.*' tbb-devel tbb libboost-devel 'mppp=1.*' sleef xtensor xtensor-blas blas blas-devel fmt spdlog
