...
conda create -y -q -p $deps_dir c-compiler cxx-compiler cmake llvmdev=10.0.1 tbb-devel tbb boost-cpp mppp sleef xtensor xtensor-blas blas blas-devel 'fmt=8.0.*' 'spdlog=1.9.2'
