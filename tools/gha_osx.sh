...
conda create -y -q -p $deps_dir c-compiler cxx-compiler libcxx cmake 'llvmdev<15' tbb-devel tbb boost-cpp sleef xtensor xtensor-blas blas blas-devel 'fmt=8.1.*' 'spdlog=1.10.*'
