...
conda create -y -q -p $deps_dir c-compiler cxx-compiler libcxx cmake llvmdev tbb-devel tbb libboost-devel sleef xtensor xtensor-blas blas blas-devel fmt spdlog 'mppp=1.*'
