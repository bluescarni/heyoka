...
TEST_CASE("multimangle")
{
    ...
    auto jptr0 = reinterpret_cast<void (*)(double *, const double *, const double *)>(s.jit_lookup("jet0"));
    ...
    jptr0(jet.data(), nullptr, nullptr);
...
TEST_CASE("taylor sub")
{
    auto tester = [](auto fp_x, unsigned opt_level, bool high_accuracy, bool compact_mode) {
        ...
        compare_batch_scalar<fp_t>({2_dbl - y, -4_dbl - x}, opt_level, high_accuracy, compact_mode);
...
TEST_CASE("taylor add")
{
    auto tester = [](auto fp_x, unsigned opt_level, bool high_accuracy, bool compact_mode) {
        ...
        // Number-number tests.
        {
            ...
            REQUIRE(jet[0] == 2);
            REQUIRE(jet[1] == 3);
            REQUIRE(jet[2] == approximately(fp_t{5}));
            REQUIRE(jet[3] == approximately(fp_t{5}));
        }
...

        {
            ...
            REQUIRE(jet[2] == 3);
            REQUIRE(jet[3] == -3);
            REQUIRE(jet[4] == approximately(fp_t{5}));
            REQUIRE(jet[5] == approximately(fp_t{5}));
            REQUIRE(jet[6] == approximately(fp_t{5}));
            REQUIRE(jet[7] == approximately(-fp_t{5}));
            REQUIRE(jet[8] == 0);
            REQUIRE(jet[9] == 0);
...

        {
            ...
            REQUIRE(jet[6] == approximately(fp_t{5}));
            REQUIRE(jet[7] == approximately(fp_t{5}));
            REQUIRE(jet[8] == approximately(fp_t{5}));
            REQUIRE(jet[9] == approximately(fp_t{5}));
            REQUIRE(jet[10] == approximately(fp_t{0}));
            REQUIRE(jet[11] == approximately(fp_t{3}));
            REQUIRE(jet[12] == 0);
