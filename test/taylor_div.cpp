    ...
    auto tester = [](auto fp_x, unsigned opt_level, bool high_accuracy, bool compact_mode) {
        ...
        if constexpr (detail::has_batch_mode<fp_t>) {
        ...
        } else {
            {
                ...
                taylor_add_jet<fp_t>(s, "jet", {y / par[0], x / par[1]}, 3, 1, high_accuracy, compact_mode);
                ...
                std::vector<fp_t> pars{fp_t{2}, fp_t{-4}};
                ...
                REQUIRE(jet[4] == approximately(fp_t{1} / 2 * (jet[3] / 2)));
                REQUIRE(jet[5] == approximately(fp_t{1} / 2 * (jet[2] / -4)));
                REQUIRE(jet[6] == approximately(fp_t{1} / 6 * jet[5]));
                REQUIRE(jet[7] == approximately(fp_t{1} / 6 * (jet[4] * fp_t{2} / fp_t{-4})));
            }
        }
        ...
        if constexpr (detail::has_batch_mode<fp_t>) {
...

            {
                ...
                REQUIRE(jet[19]
                        == approximately(-1 / fp_t{3} * (2 * jet[16] * 5 * 5 - jet[10] * 2 * 5 * jet[10])
                                         / (5 * 5 * 5 * 5)));
                REQUIRE(jet[20]
                        == approximately(-1 / fp_t{3} * (2 * jet[17] * 2 * 2 - jet[11] * 2 * -2 * jet[11])
                                         / (2 * 2 * 2 * 2)));
        ...
        } else {
            {
                ...
                taylor_add_jet<fp_t>(s, "jet", {par[0] / y, par[1] / x}, 3, 1, high_accuracy, compact_mode);
                ...
                REQUIRE(
                    jet[6]
                    == approximately(-1 / fp_t{3} * (2 * jet[5] * 3 * 3 - jet[3] * 2 * 3 * jet[3]) / (3 * 3 * 3 * 3)));
                REQUIRE(
                    jet[7]
                    == approximately(4 / fp_t{6} * (2 * jet[4] * 2 * 2 - jet[2] * 2 * 2 * jet[2]) / (2 * 2 * 2 * 2)));
            }
        }
        ...
        if constexpr (detail::has_batch_mode<fp_t>) {
...

            {
                ...
                REQUIRE(jet[19]
                        == approximately(1 / fp_t{6}
                                         * ((2 * jet[13] * 4 - 2 * jet[16] * -5) * 4 * 4
                                            - 2 * 4 * jet[10] * (jet[7] * 4 - jet[10] * -5))
                                         / (4 * 4 * 4 * 4)));
                REQUIRE(jet[20]
                        == approximately(1 / fp_t{6}
                ...
                REQUIRE(jet[22]
                        == approximately(1 / fp_t{6}
                                         * ((2 * jet[16] * -5 - 2 * jet[13] * 4) * 5 * 5
                                            - 2 * -5 * jet[7] * (jet[10] * -5 - jet[7] * 4))
                                         / (5 * 5 * 5 * 5)));
                REQUIRE(jet[23]
                        == approximately(1 / fp_t{6}
                                         * ((2 * jet[17] * 1 - 2 * jet[14] * -2) * 1 * 1
                                            - 2 * 1 * jet[8] * (jet[11] * 1 - jet[8] * -2))
                                         / (1 * 1 * 1 * 1)));
            }
        ...
        } else {
            {
                ...
                taylor_add_jet<fp_t>(s, "jet", {x / y, y / x}, 3, 1, high_accuracy, compact_mode);
