...
template <typename T>
const T pi_const = boost::math::constants::pi<T>();
...
TEST_CASE("taylor pi")
{
    auto tester = [](auto fp_x, unsigned opt_level, bool high_accuracy, bool compact_mode) {
        ...
        // Number tests.
        {
            ...
            REQUIRE(jet[0] == 2);
            REQUIRE(jet[1] == 3);
            REQUIRE(jet[2] == approximately(pi_const<fp_t>));
            REQUIRE(jet[3] == 5);
        }

        {
            ...
            REQUIRE(jet[4] == approximately(pi_const<fp_t>));
            REQUIRE(jet[5] == approximately(pi_const<fp_t>));
...

        {
            ...
            REQUIRE(jet[3] == 5);
            REQUIRE(jet[4] == 0);
            REQUIRE(jet[5] == approximately(fp_t{1} / 2 * (jet[3] + pi_const<fp_t>)));
        }

        {
            ...
            REQUIRE(jet[4] == approximately(pi_const<fp_t> + jet[0]));
            REQUIRE(jet[5] == approximately(pi_const<fp_t> + jet[1]));

            REQUIRE(jet[6] == 5);
            REQUIRE(jet[7] == -5);

            REQUIRE(jet[8] == fp_t{1} / 2 * jet[4]);
            REQUIRE(jet[9] == fp_t{1} / 2 * jet[5]);
...

        {
            ...
            REQUIRE(jet[12] == fp_t{1} / 2 * jet[6]);
            REQUIRE(jet[13] == fp_t{1} / 2 * jet[7]);
            REQUIRE(jet[14] == fp_t{1} / 2 * jet[8]);
