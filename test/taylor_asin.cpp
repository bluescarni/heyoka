...
TEST_CASE("taylor asin decompose bug 00")
{
    ...
    auto ta = taylor_adaptive<double>({prime(x) = asin(0_dbl) - x}, {0.}, kw::tol = 1.);
}
...
TEST_CASE("taylor asin test simplifications")
{
    ...
    auto ta = taylor_adaptive<double>{{prime(x) = asin(x + y) + sqrt(1. - pow(x + y, 2_dbl)), prime(y) = x},
                                      {.2, -.3},
                                      kw::opt_level = 0,
                                      kw::tol = 1.};
...
TEST_CASE("taylor asin")
{
    auto tester = [](auto fp_x, unsigned opt_level, bool high_accuracy, bool compact_mode) {
        ...
        // Number tests.
        {
            auto ta = taylor_adaptive<fp_t>{{prime(x) = asin(expression{number{fp_t{.5}}}), prime(y) = x + y},
                                            {fp_t(2), fp_t(3)},
                                            kw::tol = 1,
        ...
        {
            auto ta = taylor_adaptive<fp_t>{{prime(x) = asin(par[0]), prime(y) = x + y},
                                            {fp_t(2), fp_t(3)},
                                            kw::tol = 1,
                                            kw::high_accuracy = high_accuracy,
                                            kw::compact_mode = compact_mode,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = asin(expression{number{fp_t{.5}}}), prime(y) = x + y},
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = asin(par[1]), prime(y) = x + y},
                                                  {fp_t{2}, fp_t{-4}, fp_t{3}, fp_t{5}},
                                                  2,
                                                  kw::tol = 1,
                                                  kw::high_accuracy = high_accuracy,
        ...
        {
            auto ta = taylor_adaptive<fp_t>{{prime(x) = asin(expression{number{fp_t{.25}}}), prime(y) = x + y},
                                            {fp_t(2), fp_t(3)},
                                            kw::tol = .5,
                                            kw::high_accuracy = high_accuracy,
                                            kw::compact_mode = compact_mode,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = asin(expression{number{fp_t{.25}}}), prime(y) = x + y},
                                                  {fp_t{2}, fp_t{-4}, fp_t{3}, fp_t{5}},
                                                  2,
                                                  kw::tol = .5,
                                                  kw::high_accuracy = high_accuracy,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = asin(expression{number{fp_t{0.75}}}), prime(y) = x + y},
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = asin(par[0]), prime(y) = x + y},
                                                  {fp_t{2}, fp_t{-4}, fp_t{-1}, fp_t{3}, fp_t{5}, fp_t{-2}},
                                                  3,
                                                  kw::tol = .1,
                                                  kw::high_accuracy = high_accuracy,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            ...
            compare_batch_scalar<fp_t>({prime(x) = asin(expression{number{fp_t{.625}}}), prime(y) = x + y}, opt_level,
                                       high_accuracy, compact_mode, rng, -.9f, .9f);
        }

        // Variable tests.
        {
            auto ta = taylor_adaptive<fp_t>{{prime(x) = asin(y), prime(y) = asin(x)},
                                            {fp_t(.2), fp_t(.3)},
                                            kw::tol = 1,
                                            kw::high_accuracy = high_accuracy,
                                            kw::compact_mode = compact_mode,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = asin(y), prime(y) = asin(x)},
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            // Do the batch/scalar comparison.
            compare_batch_scalar<fp_t>({prime(x) = asin(y), prime(y) = asin(x)}, opt_level, high_accuracy, compact_mode,
                                       rng, -.9f, .9f);
        }
    };
