...
HEYOKA_S11N_CALLABLE_EXPORT2(s11n_callback, "s11n_callback_flt", void, taylor_adaptive<float> &, float, int)
HEYOKA_S11N_CALLABLE_EXPORT2(s11n_callback, "s11n_callback_dbl", void, taylor_adaptive<double> &, double, int)
HEYOKA_S11N_CALLABLE_EXPORT2(s11n_callback, "s11n_callback_ldbl", void, taylor_adaptive<long double> &, long double,
                             int)

#if defined(HEYOKA_HAVE_REAL128)

HEYOKA_S11N_CALLABLE_EXPORT2(s11n_callback, "s11n_callback_f128", void, taylor_adaptive<mppp::real128> &, mppp::real128,
                             int)
