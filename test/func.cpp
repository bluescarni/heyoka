...
TEST_CASE("func minimal")
{
    ...
    *b = "z"_var;
    ...
    REQUIRE_THROWS_MATCHES(
        f.taylor_diff_dbl(s, {nullptr, nullptr}, nullptr, 0, 2, 2, 1), std::invalid_argument,
        Message("Zero number of u variables detected in func::taylor_diff_dbl() for the function 'f'"));
    REQUIRE_THROWS_MATCHES(f.taylor_diff_dbl(s, {nullptr, nullptr}, nullptr, 2, 1, 2, 1), not_implemented_error,
    ...
    REQUIRE_THROWS_MATCHES(
        f.taylor_diff_ldbl(s, {nullptr, nullptr}, nullptr, 0, 2, 2, 1), std::invalid_argument,
        Message("Zero number of u variables detected in func::taylor_diff_ldbl() for the function 'f'"));
    REQUIRE_THROWS_MATCHES(f.taylor_diff_ldbl(s, {nullptr, nullptr}, nullptr, 2, 1, 2, 1), not_implemented_error,
    ...
    REQUIRE_THROWS_MATCHES(
        f.taylor_diff_f128(s, {nullptr, nullptr}, nullptr, 0, 2, 2, 1), std::invalid_argument,
        Message("Zero number of u variables detected in func::taylor_diff_f128() for the function 'f'"));
    REQUIRE_THROWS_MATCHES(f.taylor_diff_f128(s, {nullptr, nullptr}, nullptr, 2, 1, 2, 1), not_implemented_error,
...
TEST_CASE("func taylor diff")
{
    ...
    llvm_state s;
    REQUIRE_THROWS_MATCHES(f.taylor_diff_dbl(s, {}, nullptr, 1, 2, 3, 4), std::invalid_argument,
                           Message("Null return value detected in func::taylor_diff_dbl() for the function 'f'"));
    REQUIRE_THROWS_MATCHES(f.taylor_diff_ldbl(s, {}, nullptr, 1, 2, 3, 4), std::invalid_argument,
                           Message("Null return value detected in func::taylor_diff_ldbl() for the function 'f'"));
#if defined(HEYOKA_HAVE_REAL128)
    REQUIRE_THROWS_MATCHES(f.taylor_diff_f128(s, {}, nullptr, 1, 2, 3, 4), std::invalid_argument,
