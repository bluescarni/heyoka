...
TEST_CASE("taylor sqrt")
{
    auto tester = [](auto fp_x, unsigned opt_level, bool high_accuracy, bool compact_mode) {
...

        {
            ...
            taylor_add_jet<fp_t>(s, "jet", {sqrt(par[0]), x + y}, 1, 1, high_accuracy, compact_mode);
...

        {
            ...
            taylor_add_jet<fp_t>(s, "jet", {sqrt(par[1]), x + y}, 1, 2, high_accuracy, compact_mode);
...

        {
            ...
            taylor_add_jet<fp_t>(s, "jet", {sqrt(par[0]), x + y}, 3, 3, high_accuracy, compact_mode);
