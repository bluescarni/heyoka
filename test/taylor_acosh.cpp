...
TEST_CASE("taylor acosh test simplifications")
{
    ...
    auto ta = taylor_adaptive<double>{{prime(x) = acosh(x + y) + sqrt(pow(x + y, 2_dbl) - 1.), prime(y) = x},
                                      {1.2, 2.3},
                                      kw::opt_level = 0,
                                      kw::tol = 1.};
...
TEST_CASE("taylor acosh")
{
    auto tester = [](auto fp_x, unsigned opt_level, bool high_accuracy, bool compact_mode) {
        ...
        // Number tests.
        {
            auto ta = taylor_adaptive<fp_t>{{prime(x) = acosh(expression{number{fp_t{1.5}}}), prime(y) = x + y},
                                            {fp_t(2), fp_t(3)},
                                            kw::tol = 1,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = acosh(expression{number{fp_t{1.5}}}), prime(y) = x + y},
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = acosh(par[1]), prime(y) = x + y},
                                                  {fp_t{2}, fp_t{-4}, fp_t{3}, fp_t{5}},
                                                  2,
                                                  kw::tol = 1,
                                                  kw::high_accuracy = high_accuracy,
                                                  kw::compact_mode = compact_mode,
                                                  kw::opt_level = opt_level,
                                                  kw::pars = {fp_t{1.5}, fp_t{1.5}, fp_t(1.3), fp_t(1.3)}};
        ...
        {
            auto ta = taylor_adaptive<fp_t>{{prime(x) = acosh(expression{number{fp_t{1.25}}}), prime(y) = x + y},
                                            {fp_t(2), fp_t(3)},
                                            kw::tol = .5,
                                            kw::high_accuracy = high_accuracy,
                                            kw::compact_mode = compact_mode,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = acosh(expression{number{fp_t{1.25}}}), prime(y) = x + y},
                                                  {fp_t{2}, fp_t{-4}, fp_t{3}, fp_t{5}},
                                                  2,
                                                  kw::tol = .5,
                                                  kw::high_accuracy = high_accuracy,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = acosh(expression{number{fp_t{1.75}}}), prime(y) = x + y},
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = acosh(par[0]), prime(y) = x + y},
                                                  {fp_t{2}, fp_t{-4}, fp_t{-1}, fp_t{3}, fp_t{5}, fp_t{-2}},
                                                  3,
                                                  kw::tol = .1,
                                                  kw::high_accuracy = high_accuracy,
                                                  kw::compact_mode = compact_mode,
                                                  kw::opt_level = opt_level,
                                                  kw::pars = {fp_t{1.625}, fp_t{1.625}, fp_t{1.625}}};
        ...
        // Variable tests.
        {
            auto ta = taylor_adaptive<fp_t>{
                {prime(x) = acosh(y), prime(y) = acosh(x)}, {fp_t(1.2), fp_t(1.3)},          kw::tol = 1,
                kw::high_accuracy = high_accuracy,          kw::compact_mode = compact_mode, kw::opt_level = opt_level};
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = acosh(y), prime(y) = acosh(x)},
                                                  {fp_t(1.2), fp_t(1.1), fp_t(1.3), fp_t(1.4)},
                                                  2,
                                                  kw::tol = 1,
                                                  kw::high_accuracy = high_accuracy,
                                                  kw::compact_mode = compact_mode,
        ...
        if constexpr (!std::is_same_v<long double, fp_t> || !skip_batch_ld) {
            auto ta = taylor_adaptive_batch<fp_t>{{prime(x) = acosh(y), prime(y) = acosh(x)},
                                                  {fp_t(1.2), fp_t(1.1), fp_t{1.5}, fp_t(1.3), fp_t(1.4), fp_t(1.6)},
                                                  3,
                                                  kw::tol = .1,
                                                  kw::high_accuracy = high_accuracy,
                                                  kw::compact_mode = compact_mode,
