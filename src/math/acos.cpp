...
// Generic implementation for the codegen of acos that will invoke the external
// function fname, after the decomposition of the input argument arg into scalars.
llvm::Value *acos_codegen_impl(llvm_state &s, llvm::Value *arg, const std::string &fname)
{
...
llvm::Value *acos_impl::codegen_dbl(llvm_state &s, const std::vector<llvm::Value *> &args) const
{
    ...
    return acos_codegen_impl(s, args[0], "acos");
}
...
llvm::Value *acos_impl::codegen_ldbl(llvm_state &s, const std::vector<llvm::Value *> &args) const
{
    ...
    return acos_codegen_impl(s, args[0],
#if defined(_MSC_VER)
...
llvm::Value *acos_impl::codegen_f128(llvm_state &s, const std::vector<llvm::Value *> &args) const
{
    ...
    return acos_codegen_impl(s, args[0], "heyoka_acos128");
}
