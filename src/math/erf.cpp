...
taylor_dc_t::size_type erf_impl::taylor_decompose(taylor_dc_t &u_vars_defs) &&
{
    ...
    // Append - arg * arg.
    u_vars_defs.push_back(taylor_dc_item_t{-expression{"u_{}"_format(u_vars_defs.size() - 1u)}, {}, {}, {}});

    // Append exp( - arg * arg).
    u_vars_defs.push_back(taylor_dc_item_t{exp(expression{"u_{}"_format(u_vars_defs.size() - 1u)}), {}, {}, {}});
