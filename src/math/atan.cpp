...
// Generic implementation for the codegen of atan that will invoke the external
// function fname, after the decomposition of the input argument arg into scalars.
llvm::Value *atan_codegen_impl(llvm_state &s, llvm::Value *arg, const std::string &fname)
{
...
llvm::Value *atan_impl::codegen_dbl(llvm_state &s, const std::vector<llvm::Value *> &args) const
{
    ...
    return atan_codegen_impl(s, args[0], "atan");
}
...
llvm::Value *atan_impl::codegen_ldbl(llvm_state &s, const std::vector<llvm::Value *> &args) const
{
    ...
    return atan_codegen_impl(s, args[0],
#if defined(_MSC_VER)
...
llvm::Value *atan_impl::codegen_f128(llvm_state &s, const std::vector<llvm::Value *> &args) const
{
    ...
    return atan_codegen_impl(s, args[0], "heyoka_atan128");
}
