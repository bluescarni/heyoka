...
llvm::Function *tpoly_impl::taylor_c_diff_func_dbl(llvm_state &s, std::uint32_t n_uvars, std::uint32_t,
                                                   std::uint32_t batch_size, bool) const
{
    return taylor_c_diff_tpoly_impl<double>(s, *this, n_uvars, batch_size);
}

llvm::Function *tpoly_impl::taylor_c_diff_func_ldbl(llvm_state &s, std::uint32_t n_uvars, std::uint32_t,
                                                    std::uint32_t batch_size, bool) const
{
...
llvm::Function *tpoly_impl::taylor_c_diff_func_f128(llvm_state &s, std::uint32_t n_uvars, std::uint32_t,
                                                    std::uint32_t batch_size, bool) const
{
