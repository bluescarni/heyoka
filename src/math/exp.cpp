...
llvm::Value *exp_impl::taylor_diff_dbl(llvm_state &s, const std::vector<llvm::Value *> &arr, llvm::Value *par_ptr,
                                       std::uint32_t n_uvars, std::uint32_t order, std::uint32_t idx,
                                       std::uint32_t batch_size) const
{
    return taylor_diff_exp<double>(s, *this, arr, par_ptr, n_uvars, order, idx, batch_size);
}

llvm::Value *exp_impl::taylor_diff_ldbl(llvm_state &s, const std::vector<llvm::Value *> &arr, llvm::Value *par_ptr,
                                        std::uint32_t n_uvars, std::uint32_t order, std::uint32_t idx,
                                        std::uint32_t batch_size) const
{
    return taylor_diff_exp<long double>(s, *this, arr, par_ptr, n_uvars, order, idx, batch_size);
}

#if defined(HEYOKA_HAVE_REAL128)

llvm::Value *exp_impl::taylor_diff_f128(llvm_state &s, const std::vector<llvm::Value *> &arr, llvm::Value *par_ptr,
                                        std::uint32_t n_uvars, std::uint32_t order, std::uint32_t idx,
                                        std::uint32_t batch_size) const
{
    return taylor_diff_exp<mppp::real128>(s, *this, arr, par_ptr, n_uvars, order, idx, batch_size);
}
...
// Derivative of exp(variable).
template <typename T>
llvm::Function *taylor_c_diff_func_exp_impl(llvm_state &s, const exp_impl &fn, const variable &, std::uint32_t n_uvars,
                                            std::uint32_t batch_size)
{
...
llvm::Function *exp_impl::taylor_c_diff_func_dbl(llvm_state &s, std::uint32_t n_uvars, std::uint32_t batch_size) const
{
    return taylor_c_diff_func_exp<double>(s, *this, n_uvars, batch_size);
}

llvm::Function *exp_impl::taylor_c_diff_func_ldbl(llvm_state &s, std::uint32_t n_uvars, std::uint32_t batch_size) const
{
...
llvm::Function *exp_impl::taylor_c_diff_func_f128(llvm_state &s, std::uint32_t n_uvars, std::uint32_t batch_size) const
{
