...
inline constexpr unsigned long vsop2013_3_5_sizes[8] = {
    7293ul, 3681ul, 1964ul, 953ul, 446ul, 126ul, 19ul, 1ul,
};
inline constexpr unsigned long vsop2013_3_6_sizes[8] = {
    6766ul, 3593ul, 1877ul, 935ul, 438ul, 115ul, 18ul, 1ul,
};

extern const vsop2013_term *const vsop2013_3_1_data[9];
extern const vsop2013_term *const vsop2013_3_2_data[11];
extern const vsop2013_term *const vsop2013_3_3_data[10];
extern const vsop2013_term *const vsop2013_3_4_data[10];
extern const vsop2013_term *const vsop2013_3_5_data[8];
extern const vsop2013_term *const vsop2013_3_6_data[8];
