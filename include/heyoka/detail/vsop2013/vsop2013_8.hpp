...
inline constexpr unsigned long vsop2013_8_5_sizes[9] = {
    6409ul, 3589ul, 1970ul, 966ul, 393ul, 149ul, 55ul, 19ul, 2ul,
};
inline constexpr unsigned long vsop2013_8_6_sizes[11] = {
    6391ul, 3612ul, 1981ul, 965ul, 391ul, 142ul, 52ul, 20ul, 4ul, 2ul, 2ul,
};

extern const vsop2013_term *const vsop2013_8_1_data[12];
extern const vsop2013_term *const vsop2013_8_2_data[11];
extern const vsop2013_term *const vsop2013_8_3_data[11];
extern const vsop2013_term *const vsop2013_8_4_data[11];
extern const vsop2013_term *const vsop2013_8_5_data[9];
extern const vsop2013_term *const vsop2013_8_6_data[11];
