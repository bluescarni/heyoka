...
inline constexpr unsigned long vsop2013_1_5_sizes[9] = {
    6948ul, 3811ul, 1793ul, 909ul, 446ul, 163ul, 67ul, 19ul, 3ul,
};
inline constexpr unsigned long vsop2013_1_6_sizes[9] = {
    8064ul, 4404ul, 2155ul, 1041ul, 513ul, 208ul, 86ul, 27ul, 6ul,
};

extern const vsop2013_term *const vsop2013_1_1_data[11];
extern const vsop2013_term *const vsop2013_1_2_data[11];
extern const vsop2013_term *const vsop2013_1_3_data[11];
extern const vsop2013_term *const vsop2013_1_4_data[11];
extern const vsop2013_term *const vsop2013_1_5_data[9];
extern const vsop2013_term *const vsop2013_1_6_data[9];
