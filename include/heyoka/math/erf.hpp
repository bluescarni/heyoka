...
#ifndef HEYOKA_MATH_ERF_HPP
#define HEYOKA_MATH_ERF_HPP
...
class HEYOKA_DLL_PUBLIC erf_impl : public func_base
{
...
class HEYOKA_DLL_PUBLIC erfc_impl : public func_base
{
    friend class boost::serialization::access;
    template <typename Archive>
    void serialize(Archive &ar, unsigned)
...
HEYOKA_DLL_PUBLIC expression erf(expression);
HEYOKA_DLL_PUBLIC expression erfc(expression);

HEYOKA_END_NAMESPACE

HEYOKA_S11N_FUNC_EXPORT_KEY(heyoka::detail::erf_impl)
HEYOKA_S11N_FUNC_EXPORT_KEY(heyoka::detail::erfc_impl)
