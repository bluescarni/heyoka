...
class HEYOKA_DLL_PUBLIC acosh_impl : public func_base
{
...
HEYOKA_DLL_PUBLIC expression acosh(expression);

} // namespace heyoka

HEYOKA_S11N_FUNC_EXPORT_KEY(heyoka::detail::acosh_impl)
